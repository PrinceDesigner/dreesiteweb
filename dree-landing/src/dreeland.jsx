      ...
      <nav className="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-md z-50 border-b border-slate-100">
        <div className="container mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2 cursor-pointer" onClick={() => window.scrollTo(0,0)}>
            ...
            <div className="w-10 h-10 bg-[#2EA7A0] rounded-xl flex items-center justify-center text-white font-bold text-2xl shadow-lg shadow-[#2EA7A0]/20">
              D
            </div>
            <span className="text-2xl font-bold tracking-tight text-slate-900">Dree</span>
          </div>
            ...
            <div className="lg:w-1/2 w-full">
              <div className="relative w-full h-[500px] bg-slate-800 rounded-3xl p-2 border border-slate-700 shadow-2xl group">
                <div className="relative w-full h-full bg-slate-700 rounded-2xl overflow-hidden">
                  ...
                  {/* House Inside */}
                  <div className="absolute top-[45%] left-[55%] flex flex-col items-center animate-bounce delay-700">
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-16">
            <div className="col-span-2">
              <div className="flex items-center gap-2 mb-6">
                {/* BRAND COLOR APPLIED HERE */}
                <div className="w-8 h-8 bg-[#2EA7A0] rounded-lg flex items-center justify-center text-white font-bold">D</div>
                <span className="text-xl font-bold text-slate-900">Dree</span>
              </div>
              ...
              <div className="flex gap-4">
                <button className="w-10 h-10 rounded-full bg-slate-50 shadow-sm flex items-center justify-center text-slate-600 hover:text-[#2EA7A0] transition-colors"><Instagram size={20} /></button>
                <button className="w-10 h-10 rounded-full bg-slate-50 shadow-sm flex items-center justify-center text-slate-600 hover:text-[#2EA7A0] transition-colors"><Twitter size={20} /></button>
                <button className="w-10 h-10 rounded-full bg-slate-50 shadow-sm flex items-center justify-center text-slate-600 hover:text-[#2EA7A0] transition-colors"><Facebook size={20} /></button>
              </div>
            </div>
